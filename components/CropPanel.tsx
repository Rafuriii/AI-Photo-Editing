...
const CropPanel: React.FC<CropPanelProps> = ({ onApplyCrop, onSetAspect, isLoading, isCropping }) => {
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-gray-300">Potong Gambar</h3>
      <p className="text-sm text-gray-400 -mt-2">Klik dan seret pada gambar untuk memilih area potong.</p>
      
      <div className="flex items-center gap-2">
        <span className="text-sm font-medium text-gray-400">Rasio Aspek:</span>
