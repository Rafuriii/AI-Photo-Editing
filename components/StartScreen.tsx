    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
          AI Foto Editing Cepat dan <span className="text-blue-400">Mudah Digunakan</span>.
        </h1>
        <p className="max-w-2xl text-lg text-gray-400 md:text-xl">
          Edit foto, terapkan filter kreatif, atau lakukan penyesuaian profesional menggunakan perintah teks sederhana. Tidak perlu alat yang rumit.
        </p>
        ...
        <div className="mt-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-100">Retouch Tepat</h3>
                ...
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    ...
                    <p className="mt-2 text-gray-400">Ubah foto dengan gaya artistik. Dari tampilan vintage hingga cahaya futuristik, temukan atau buat filter yang sempurna.</p>
                </div>
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
